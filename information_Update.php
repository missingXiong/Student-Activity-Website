   ...
   <center>
	 ...
	 <div class="form">
       <form class="register-form" method = "post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
		...
		<p>Phone Number</p>
		<input type="text" placeholder="Phone Number Number" pattern="[0-9]{10}" onchange="try{setCustomValidity('')}catch(e){}" oninvalid="setCustomValidity('Enter correct Phonenumber number')"  name = "Phonenumber" value="<?php echo isset($_POST["Phonenumber"]) ? $_POST["Phonenumber"] : ''; ?>" required/>
		<p>Department</p>
        ...
        <p class="message">Don't want to update information? <a href="main.php">Go To Main Page</a></p>
