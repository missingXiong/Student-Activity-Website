...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <style>
      body {
            background-image: url('images/txst.jpg');
  ...
  <div class="col-md-4">
    ...
    <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body mt-2 pd-2" style="min-height: 210px">
              <p class="card-text">You can buy bus tickets online by credit card. You can choose multiple plans and buy multiple tickets. </p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
