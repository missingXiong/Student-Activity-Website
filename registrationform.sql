...
ALTER TABLE `registrationform` CHANGE `Phonenumber` `Phonenumber` DECIMAL(10) NOT NULL;
ALTER TABLE `registrationform` CHANGE `Zipcode` `Zipcode` DECIMAL(5) NOT NULL;

ALTER TABLE `registrationform` ADD `gender` ENUM('male','female') NOT NULL AFTER `Lastname`;
