...
header("Pragma: no-cache");
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST")
   {
    ...
    if (!$errorflag)
    {
			try
			{
		     $sql = "UPDATE registrationform SET Firstname = '$Firstname', Lastname = '$Lastname', Address = '$Address', City = '$City', State = '$State', Zipcode = $Zipcode, Department = '$Department', Phonenumber = '$Phonenumber'";
             if ($changepass==1)
             {
