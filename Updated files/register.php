	 ...
	 $sql = "SELECT Username FROM registrationform WHERE Username = '$Username'";
      ...
      if($count == 1) {
		 $display_result= "This Username is already taken. Please use different Username.";
		   ...
		   $sql = "INSERT INTO registrationform (Firstname, Lastname, Address, City, State, Zipcode, EmailID, Department, Phonenumber, Username, Password) VALUES ('$Firstname','$Lastname','$Address', '$city', '$state', $zipcode, '$EmailID', '$Department', $Phonenumber, '$Username', '$Password')";
